...
def p_list_obj(t):
	...
	if len(t)<2:
		...
		a=[]
		#maybe we don't need this but "nobody got time to think about it"
...
def p_list(t):
	'list : obracket list_obj cbracket'
	t[0]=node.List(t[2])

def p_listAccess(t):
	'expression : identifier obracket integer cbracket'
	t[0]=node.Subscript(t[1],node.Const(t[3]))
