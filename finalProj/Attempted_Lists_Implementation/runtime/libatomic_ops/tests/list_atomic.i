# 1 "list_atomic.c"
# 1 "/Users/giuseppemendola/Desktop/ht/bdwgc/libatomic_ops/tests//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "list_atomic.c"
...
AO_load(const volatile size_t *addr)
{
    ...
    (__builtin_expect(!(((size_t)addr & (sizeof(*addr) - 1)) == 0), 0) ? __assert_rtn(__func__, "../src/atomic_ops/sysdeps/gcc/../loadstore/atomic_load.h", 31, "((size_t)addr & (sizeof(*addr) - 1)) == 0") : (void)0);
...
AO_short_load(const volatile unsigned short *addr)
{
    ...
    (__builtin_expect(!(((size_t)addr & (sizeof(*addr) - 1)) == 0), 0) ? __assert_rtn(__func__, "../src/atomic_ops/sysdeps/gcc/../loadstore/short_atomic_load.h", 31, "((size_t)addr & (sizeof(*addr) - 1)) == 0") : (void)0);
...
AO_int_load(const volatile unsigned *addr)
{
    ...
    (__builtin_expect(!(((size_t)addr & (sizeof(*addr) - 1)) == 0), 0) ? __assert_rtn(__func__, "../src/atomic_ops/sysdeps/gcc/../loadstore/int_atomic_load.h", 31, "((size_t)addr & (sizeof(*addr) - 1)) == 0") : (void)0);
...
AO_store(volatile size_t *addr, size_t new_val)
{
    ...
    (__builtin_expect(!(((size_t)addr & (sizeof(*addr) - 1)) == 0), 0) ? __assert_rtn(__func__, "../src/atomic_ops/sysdeps/gcc/../loadstore/atomic_store.h", 31, "((size_t)addr & (sizeof(*addr) - 1)) == 0") : (void)0);
...
AO_short_store(volatile unsigned short *addr, unsigned short new_val)
{
    ...
    (__builtin_expect(!(((size_t)addr & (sizeof(*addr) - 1)) == 0), 0) ? __assert_rtn(__func__, "../src/atomic_ops/sysdeps/gcc/../loadstore/short_atomic_store.h", 31, "((size_t)addr & (sizeof(*addr) - 1)) == 0") : (void)0);
...
AO_int_store(volatile unsigned *addr, unsigned new_val)
{
    ...
    (__builtin_expect(!(((size_t)addr & (sizeof(*addr) - 1)) == 0), 0) ? __assert_rtn(__func__, "../src/atomic_ops/sysdeps/gcc/../loadstore/int_atomic_store.h", 31, "((size_t)addr & (sizeof(*addr) - 1)) == 0") : (void)0);
